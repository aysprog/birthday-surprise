...
Enjoy your special day! 🎉`;
        ...
        const gifts = [
            ...
            "🎂 A giant birthday cake just for you!",

            "🌸 Sending you lots of happiness.",

            "🎈 May today be full of beautiful memories.",

            "💖 You deserve every smile in the world.",

            "✨ Keep shining exactly the way you do.",

            "🎁 Surprise! This gift contains unlimited hugs."
        ...
        giftBoxes.forEach((gift, index) => {
            ...
            gift.addEventListener("click", () => {
                ...
                if (giftMessage) {
                    ...
                    giftMessage.innerHTML = gifts[index % gifts.length];

                    giftMessage.classList.remove("hidden");

                    giftMessage.classList.add("zoom-in");
